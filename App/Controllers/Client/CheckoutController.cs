...
public class CheckoutController : Controller {
    ...
    public CheckoutController(ILogger<CheckoutController> logger, OrderRepository orderRepository, PaymentMethodRepository paymentMethodRepository, ApplicationDbContext dbContext, OrderItemRepository orderItemRepository) {
        _logger = logger;
