...
public class CategoryController : Controller {
    ...
    public async Task<IActionResult> Store(CategoryRequest categoryRequest) {
    ...
    public async Task<IActionResult> Update(int categoryId, CategoryRequest categoryRequest) {
